...
{\sl \textbf{Spectrum: Spectre Attacks on a Speculating RISC-V Microarchitecture}} | Workshop Publication\\

 \vspace{-4mm}

\begin{itemize}
 \item Full name: Spectrum: Classifying, Replicating, and Mitigating Spectre Attacks on a Speculating RISC-V Microarchitecture.
 \item Replicated Spectre v1/2 attacks on open-source BOOM core.
 \item Mitigated attack using speculation buffer and MSHRs.
 \item Presented at CARRV 2019.
\end{itemize}
...
\begin{itemize}
 ...
 \item Proficient: VHDL, ARM Assembly, Android Java, C\#, and Subversion.
\end{itemize}
 \vspace{-4mm}
...
{\sl \textbf{Other}} | AWS EC2 (F1 platform), Cadence Physical Design tooling.\\
